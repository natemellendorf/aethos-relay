...
No circular dependencies exist because each phase only depends on earlier phases in the strict forward order (1 → 2 → 3 → 4), and no phase points back to itself or to any later phase.
